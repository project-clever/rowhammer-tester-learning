...
from rowhammer_tester.scripts.playbook.lib import generate_trr_test_payload_from_row_list
...
class TRRPayloadGenerator(PayloadGenerator):
    _valid_module_keys = set(
        [
            "row_generator", "read_count", "verbose", "row_generator_config",
            "row_mapping", "iterations", "fill_local", "refresh"
        ])
    ...
    def initialize(self, config):
        ...
        self.iterations = self.module_config["iterations"]
    ...
    def get_payload(self, *, settings, bank, payload_mem_size, sys_clk_freq=None):
        ...
        return generate_trr_test_payload_from_row_list(
